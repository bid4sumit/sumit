...
public class SOAPI {
    ...
    public String web2="<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n" +
            "    \t<soap:Body>\n" +
            "        \t\t<ns1:process xmlns:ns1=\"http://xmlns.oracle.com/CUR/AndroidBOTInteraction/BPELProcess1\">\n" +
            "            \t\t\t<ns1:opCode>FirstInteractionBOT</ns1:opCode>\n" +
            "            \t\t\t<ns1:input1>value111</ns1:input1>\n" +
            "            \t\t\t<ns1:input2>value222</ns1:input2>\n" +
            "        </ns1:process>\n" +
            "    </soap:Body>\n" +
            "</soap:Envelope>";
    ...
    public String IB_Retrigger_Fire_IB(String xml) {
        ...
        try {
            ...
            URL url = new URL("http://dfmw001zatcrh.vodacom.corp:8001/soa-infra/services/default/AndroidBOTInteraction/bpelprocess1_client_ep");
